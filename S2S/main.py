...
from read_data_binary import DataLoader, n_ary_heads
...
#    parser.add_argument('--n_arity', type=int, default=2, help='')
    ...
    parser.add_argument('--gpu', type=int, default=2, help='set gpu #')                    
    parser.add_argument('--trial', type=str, default="1", help='')
